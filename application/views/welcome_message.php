        ...
        <div class="col-md-6 col-lg-5 mb-7">
          ...
          <div class="media pr-lg-5">
            ...
            <div class="media-body">
              ...
              <a class="font-size-1" href="/contact">Explore now <span class="fas fa-angle-right align-middle ml-2"></span></a>
            </div>
          </div>
          <!-- End Icon Blocks -->
        </div>
      ...
      <div class="js-slick-carousel u-slick u-slick--gutters-1"
        ...
        <div class="js-slide">
          <div class="bg-light rounded py-9 px-3">
            <a href="<?php echo $certification->url; ?>" target="_blank"><img class="u-clients" src="/uploads/certification/<?php echo $certification->image_filename; ?>" alt="<?php echo $certification->name; ?>"></a>
          </div>
        </div>
        <?php endforeach; ?>
      </div>
