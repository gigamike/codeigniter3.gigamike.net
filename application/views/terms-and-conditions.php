        ...
        <div class="col-md-8 col-lg-9">
          <div id="intro" class="space-bottom-1">
            ...
            <div class="border-bottom pb-5 mb-5">
              <h1 class="text-primary"><span class="font-weight-semi-bold">Gigamike</span> Terms &amp; conditions</h1>
            ...
            <!-- Title -->
            <div class="mb-3">
              <h2 class="h5">Welcome to Gigamike</h2>
            </div>
            <!-- End Title -->

            <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("Gigamike"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.
          ...
          <div id="services" class="space-bottom-1">
            ...
            <ul class="text-secondary">
              <li class="pb-2">When you register for a Gigamike account we collect your full name, email address, and account log-in credentials.</li>
              ...
              <li class="pb-2">When you use the "Remember Me" feature of Gigamike Checkout, we collect your email address, payment card number, CVC code and expiration date.</li>
            </ul>

            <p>When you respond to Gigamike emails or surveys we collect your email address, name and any other information you choose to include in the body of your email or responses. If you contact us by phone, we will collect the phone number you use to call Gigamike. If you contact us by phone as a Gigamike User, we may collect additional information in order to verify your identity.</p>
          ...
          <div id="privacy" class="space-bottom-1">
            ...
            <p>Gigamike's privacy policies explain how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that Gigamike can use such data in accordance with our privacy policies.</p>
          ...
          <div id="yourContent">
            ...
            <p>When you upload, submit, store, send or receive content to or through our Services, you give Gigamike (and those we work with) a worldwide license to use, host, store, reproduce, modify, create derivative works (such as those resulting from translations, adaptations or other changes we make so that your content works better with our Services), communicate, publish, publicly perform, publicly display and distribute such content. The rights you grant in this license are for the limited purpose of operating, promoting, and improving our Services, and to develop new ones. This license continues even if you stop using our Services (for example, for a business listing you have added to Gigamike Maps). Some Services may offer you ways to access and remove content that has been provided to that Service. Also, in some of our Services, there are terms or settings that narrow the scope of our use of the content submitted in those Services. Make sure you have the necessary rights to grant us this license for any content that you submit to our Services.</p>
          </div>
        </div>
      </div>
    </div>
